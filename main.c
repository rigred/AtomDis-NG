...
const optab_t optable[256] = {
    [0x00] = { NULL, NULL, D_null, 0, 0 },
    [0x01] = { op_destsrc, "MOVE", D_REG, 0, 0 },
    [0x02] = { op_destsrc, "MOVE", D_PS, 0, 0 },
    [0x03] = { op_destsrc, "MOVE", D_WS, 0, 0 },
    [0x04] = { op_destsrc, "MOVE", D_FB, 0, 0 },
    [0x05] = { op_destsrc, "MOVE", D_PLL, 0, 0 },
    [0x06] = { op_destsrc, "MOVE", D_MC, 0, 0 },
    [0x07] = { op_destsrc, "AND", D_REG, 0, 0 },
    [0x08] = { op_destsrc, "AND", D_PS, 0, 0 },
    [0x09] = { op_destsrc, "AND", D_WS, 0, 0 },
    [0x0a] = { op_destsrc, "AND", D_FB, 0, 0 },
    [0x0b] = { op_destsrc, "AND", D_PLL, 0, 0 },
    [0x0c] = { op_destsrc, "AND", D_MC, 0, 0 },
    [0x0d] = { op_destsrc, "OR", D_REG, 0, 0 },
    [0x0e] = { op_destsrc, "OR", D_PS, 0, 0 },
    [0x0f] = { op_destsrc, "OR", D_WS, 0, 0 },
    [0x10] = { op_destsrc, "OR", D_FB, 0, 0 },
    [0x11] = { op_destsrc, "OR", D_PLL, 0, 0 },
    [0x12] = { op_destsrc, "OR", D_MC, 0, 0 },
    [0x13] = { op_shift,   "SHIFT_LEFT", D_REG, 0, 0 },
    [0x14] = { op_shift,   "SHIFT_LEFT", D_PS, 0, 0 },
    [0x15] = { op_shift,   "SHIFT_LEFT", D_WS, 0, 0 },
    [0x16] = { op_shift,   "SHIFT_LEFT", D_FB, 0, 0 },
    [0x17] = { op_shift,   "SHIFT_LEFT", D_PLL, 0, 0 },
    [0x18] = { op_shift,   "SHIFT_LEFT", D_MC, 0, 0 },
    [0x19] = { op_shift,   "SHIFT_RIGHT", D_REG, 0, 0 },
    [0x1a] = { op_shift,   "SHIFT_RIGHT", D_PS, 0, 0 },
    [0x1b] = { op_shift,   "SHIFT_RIGHT", D_WS, 0, 0 },
    [0x1c] = { op_shift,   "SHIFT_RIGHT", D_FB, 0, 0 },
    [0x1d] = { op_shift,   "SHIFT_RIGHT", D_PLL, 0, 0 },
    [0x1e] = { op_shift,   "SHIFT_RIGHT", D_MC, 0, 0 },
    [0x1f] = { op_destsrc, "MUL", D_REG, 0, 0 },
    [0x20] = { op_destsrc, "MUL", D_PS, 0, 0 },
    [0x21] = { op_destsrc, "MUL", D_WS, 0, 0 },
    [0x22] = { op_destsrc, "MUL", D_FB, 0, 0 },
    [0x23] = { op_destsrc, "MUL", D_PLL, 0, 0 },
    [0x24] = { op_destsrc, "MUL", D_MC, 0, 0 },
    [0x25] = { op_destsrc, "DIV", D_REG, 0, 0 },
    [0x26] = { op_destsrc, "DIV", D_PS, 0, 0 },
    [0x27] = { op_destsrc, "DIV", D_WS, 0, 0 },
    [0x28] = { op_destsrc, "DIV", D_FB, 0, 0 },
    [0x29] = { op_destsrc, "DIV", D_PLL, 0, 0 },
    [0x2a] = { op_destsrc, "DIV", D_MC, 0, 0 },
    [0x2b] = { op_destsrc, "ADD", D_REG, 0, 0 },
    [0x2c] = { op_destsrc, "ADD", D_PS, 0, 0 },
    [0x2d] = { op_destsrc, "ADD", D_WS, 0, 0 },
    [0x2e] = { op_destsrc, "ADD", D_FB, 0, 0 },
    [0x2f] = { op_destsrc, "ADD", D_PLL, 0, 0 },
    [0x30] = { op_destsrc, "ADD", D_MC, 0, 0 },
    [0x31] = { op_destsrc, "SUB", D_REG, 0, 0 },
    [0x32] = { op_destsrc, "SUB", D_PS, 0, 0 },
    [0x33] = { op_destsrc, "SUB", D_WS, 0, 0 },
    [0x34] = { op_destsrc, "SUB", D_FB, 0, 0 },
    [0x35] = { op_destsrc, "SUB", D_PLL, 0, 0 },
    [0x36] = { op_destsrc, "SUB", D_MC, 0, 0 },
    [0x37] = { op_setpt1,  "SET_ATI_PORT",      D_hex16, INDEX_REG_MM, INDEX_ATI_PORT },
    [0x38] = { op_setpt0,  "SET_PCI_PORT",      D_null , INDEX_REG_PCICONFIG, 0 },
    [0x39] = { op_setpt0,  "SET_SystemIO_PORT", D_null , INDEX_REG_SYSTEMIO, 0 },
    [0x3a] = { op_setrb,   "SET_REG_BLOCK",     D_hex16, 0, 0 },
    [0x3b] = { op_src,     "SET_FB_BASE",       D_hex16, 0, 0 },
    [0x3c] = { op_destsrc, "COMP", D_REG, 0, 0 },
    [0x3d] = { op_destsrc, "COMP", D_PS, 0, 0 },
    [0x3e] = { op_destsrc, "COMP", D_WS, 0, 0 },
    [0x3f] = { op_destsrc, "COMP", D_FB, 0, 0 },
    [0x40] = { op_destsrc, "COMP", D_PLL, 0, 0 },
    [0x41] = { op_destsrc, "COMP", D_MC, 0, 0 },
    [0x42] = { op_switch,  "SWITCH", D_hex16, 0, 0 },
    [0x43] = { op_1x16,    "JUMP", D_hex16, 0, 0 },
    [0x44] = { op_1x16,    "JUMP_Equal", D_hex16, 0, 0 },
    [0x45] = { op_1x16,    "JUMP_Below", D_hex16, 0, 0 },
    [0x46] = { op_1x16,    "JUMP_Above", D_hex16, 0, 0 },
    [0x47] = { op_1x16,    "JUMP_BelowOrEq", D_hex16, 0, 0 },
    [0x48] = { op_1x16,    "JUMP_AboveOrEq", D_hex16, 0, 0 },
    [0x49] = { op_1x16,    "JUMP_NotEqual", D_hex16, 0, 0 },
    [0x4a] = { op_destsrc, "TEST", D_REG, 0, 0 },
    [0x4b] = { op_destsrc, "TEST", D_PS, 0, 0 },
    [0x4c] = { op_destsrc, "TEST", D_WS, 0, 0 },
    [0x4d] = { op_destsrc, "TEST", D_FB, 0, 0 },
    [0x4e] = { op_destsrc, "TEST", D_PLL, 0, 0 },
    [0x4f] = { op_destsrc, "TEST", D_MC, 0, 0 },
    [0x50] = { op_1x8,     "DELAY_MilliSec", D_hex8, 0, 0 },
    [0x51] = { op_1x8,     "DELAY_MicroSec", D_hex8, 0, 0 },
    [0x52] = { op_1x8,     "CALL_TABLE", D_hex8, 0, INDEX_COMMAND_TABLE },
    [0x53] = { op_1x8,     "<deprecated> REPEAT", D_hex8, 0, 0 },
    [0x54] = { op_dest,    "CLEAR", D_REG, 0, 0 },
    [0x55] = { op_dest,    "CLEAR", D_PS, 0, 0 },
    [0x56] = { op_dest,    "CLEAR", D_WS, 0, 0 },
    [0x57] = { op_dest,    "CLEAR", D_FB, 0, 0 },
    [0x58] = { op_dest,    "CLEAR", D_PLL, 0, 0 },
    [0x59] = { op_dest,    "CLEAR", D_MC, 0, 0 },
    [0x5a] = { op_0x,      "NOP", D_null, 0, 0 },
    [0x5b] = { op_0x,      "EOT", D_null, 0, 0 },
    [0x5c] = { op_mask,    "MASK", D_REG, 0, 0 },
    [0x5d] = { op_mask,    "MASK", D_PS, 0, 0 },
    [0x5e] = { op_mask,    "MASK", D_WS, 0, 0 },
    [0x5f] = { op_mask,    "MASK", D_FB, 0, 0 },
    [0x60] = { op_mask,    "MASK", D_PLL, 0, 0 },
    [0x61] = { op_mask,    "MASK", D_MC, 0, 0 },
    [0x62] = { op_1x8,     "POST_CARD", D_hex8, 0, 0 },
    [0x63] = { op_1x8,     "<!impl> BEEP", D_hex8, 0, 0 },
    [0x64] = { op_0x,      "<deprecated> SAVE_REG", D_null, 0, 0 },
    [0x65] = { op_0x,      "<deprecated> RESTORE_REG", D_null, 0, 0 },
    [0x66] = { op_sdb,     "SET_DATA_BLOCK", D_hex8, 0, INDEX_DATA_TABLE },
    [0x67] = { op_destsrc, "XOR", D_REG, 0, 0 },
    [0x68] = { op_destsrc, "XOR", D_PS, 0, 0 },
    [0x69] = { op_destsrc, "XOR", D_WS, 0, 0 },
    [0x6a] = { op_destsrc, "XOR", D_FB, 0, 0 },
    [0x6b] = { op_destsrc, "XOR", D_PLL, 0, 0 },
    [0x6c] = { op_destsrc, "XOR", D_MC, 0, 0 },
    [0x6d] = { op_destsrc, "SHL", D_REG, 0, 0 },
    [0x6e] = { op_destsrc, "SHL", D_PS, 0, 0 },
    [0x6f] = { op_destsrc, "SHL", D_WS, 0, 0 },
    [0x70] = { op_destsrc, "SHL", D_FB, 0, 0 },
    [0x71] = { op_destsrc, "SHL", D_PLL, 0, 0 },
    [0x72] = { op_destsrc, "SHL", D_MC, 0, 0 },
    [0x73] = { op_destsrc, "SHR", D_REG, 0, 0 },
    [0x74] = { op_destsrc, "SHR", D_PS, 0, 0 },
    [0x75] = { op_destsrc, "SHR", D_WS, 0, 0 },
    [0x76] = { op_destsrc, "SHR", D_FB, 0, 0 },
    [0x77] = { op_destsrc, "SHR", D_PLL, 0, 0 },
